      ...
      <div class="text-center">
        ...
        <form method="POST" action="">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="Nama_Barang" placeholder="Nama Barang" name="Nama_Barang" autofocus required autocomplete="off">
          </div>
          <div class="form-group">
            <label for="Stok">Stok</label>
            <input type="text" class="form-control" id="Stok" placeholder="Stok" name="Stok" required autocomplete="off">
          </div>
          <div class="form-group">
