  ...
  <div class="row">
    <div class="col-md-2 pr-3 pt-4 bg-secondary">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="index.php"><i class="fas fa-store"></i></i></i> Data Barang</a>
          <hr>
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-10 p-4 pt-4">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item"><img src="image/gorengg" <?= $barang['Foto']; ?> alt="" width="120px"></li>
