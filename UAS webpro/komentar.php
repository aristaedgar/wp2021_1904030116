...
$tambahkomen = query("SELECT * FROM komentar");

if (isset($_POST['search'])) {
  $tambahkomen = cari($_POST['kata_kunci']);
}
?>
      ...
      <form method="POST" action="">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <?php $no = 1; ?>
            <tr>
              <?php foreach ($tambahkomen as $komen) : ?>
                <th scope="row"><?php echo $no; ?></th>
                <td><?php echo $komen['Nama']; ?></td>
                <td><?php echo $komen['Alamat']; ?></td>
                <td><?php echo $komen['Komentar']; ?></td>
                <td><a href="detail_komen.php?id=<?= $komen['id']; ?>" class="btn btn-warning" role="button">Detail</a></td>
            </tr>
            <?php $no++ ?>
          <?php endforeach ?>
          </tbody>
