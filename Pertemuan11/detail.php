...
$id = $_GET['id'];
$camaba = query("SELECT * FROM calon_mahasiswa WHERE ID=$id");
//var_dump($camaba);
  ...
  <div class="row">
    ...
    <div class="col-md-10 p-4 pt-4">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item"><img src="image/cowo" <?= $camaba['foto_maba']; ?> alt="" width="120px"></li>
        <li class="list-group-item"><img src="image/cewe" <?= $camaba['foto_maba']; ?> alt="" width="120px"></li>
        <li class="list-group-item">
          <a href="edit.php?id=<?= $camaba['id']; ?>" class="btn btn-warning" role="button">Edit</a> |
          <a href="hapus.php?id=<?= $camaba['id']; ?>" onclick="return confirm" class="btn btn-danger" role="button">Hapus</a> |
