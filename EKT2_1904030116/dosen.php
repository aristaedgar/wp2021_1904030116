...
$dafdos = query("SELECT * FROM dosen");

if (isset($_POST['search'])) {
  $dafdos = cari($_POST['kata_kunci']);
}
?>
...
<body>
  ...
  <div class="row">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!-- konten -->
      <h3><i class=></i> Dosen Fakultas Teknik</h3>
      <hr>
        ...
        <tbody>
          ...
          <tr>
            <?php foreach ($dafdos as $dos) : ?>
              ...
              <td><a href="detaildosen.php?id=<?= $dos['id']; ?>" class="btn btn-warning" role="button">Detail</a></td>
          </tr>
          <?php $no++ ?>
        <?php endforeach ?>
        </tbody>
