...
$id = $_GET['id'];
$dafdos = query("SELECT * FROM dosen WHERE id=$id");
  ...
  <div class="row">
    <div class="col-md-2 pr-3 pt-4 bg-secondary">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="tambah.php"><i class="fas fa-user-edit"></i> Input Daftar Dosen</a>
          <hr>
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!-- konten -->
      <h3><i class=></i> Data Dosen Fakultas Teknik</h3>
      <hr>

      <ul class="list-group">
        <li class="list-group-item active"></li>
        <li class="list-group-item"><img src="image/cowo" width="100px"></li>
        ...
        <li class="list-group-item">Pendidikan S1 : <?= $dafdos['s1']; ?></li>
